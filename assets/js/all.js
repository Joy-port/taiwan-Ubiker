...
var tabsRenderList = document.querySelector('.js-render-list');
var searchCityList = document.querySelector('.js-city-list');
var locationBtn = document.querySelector('.js-location-btn'); // 清單內容

var contentList = document.querySelector('.js-content-list'); //expend btn

var expendBtn = document.querySelector('.js-expend-btn');
var expendBox = document.querySelector('.js-expend-box'); //初始畫面
...
var markers = L.markerClusterGroup({
  iconCreateFunction: function iconCreateFunction(cluster) {
    ...
    return L.divIcon({
      html: "<div class=\"d-flex justify-content-center align-items-center marker-cluster\">".concat(markers.length, "</div>"),
...
tabs.addEventListener('click', changeTabs); //切換tab時增加樣式

function changeTabs(e) {
  tabStatus = e.target.closest('li').dataset.tab;
  var tabs = document.querySelectorAll('.js-map-tabs li');
...
function addActiveColor(e) {
  var contents = document.querySelectorAll('.js-content-list li');
...
function showRouteOnMap(e) {
  removeRouteLayers(); //要改為filterData
...
function getStationData() {
  ...
  axios({
    method: 'get',
    url: "https://ptx.transportdata.tw/MOTC/v2/Bike/Station/".concat(city, "?$format=JSON"),
    header: GetAuthorizationHeader()
  }).then(function (res) {
...
function getAvailableCityData(city) {
  axios({
    method: 'get',
    url: "https://ptx.transportdata.tw/MOTC/v2/Bike/Availability/".concat(city, "?$format=JSON"),
    header: GetAuthorizationHeader()
  }).then(function (res) {
    ...
    drawBikeStationOnMap(filterData);
    showBikeStationList(filterData); //跑到點擊的城市範圍
...
function getCurrentPosition() {
  if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(function (position) {
      ...
      latitude = position.coords.latitude; //地圖上畫出當場位置
...
exports.bikeShapeData = exports.bikeAvaData = exports.bikeCityData = void 0;
//測試用資料
var bikeCityData = [{
  "StationUID": "TPE0001",
  "StationID": "0001",
...
exports.bikeCityData = bikeCityData;
var bikeAvaData = [{
  "StationUID": "TPE0001",
  "StationID": "0001",
  "ServiceStatus": 1,
...
exports.bikeAvaData = bikeAvaData;
var bikeShapeData = [{
  "RouteName": "三元街(東北側1)",
  "AuthorityName": "臺北市政府",
  "CityCode": "TPE",
...
exports.bikeShapeData = bikeShapeData;
